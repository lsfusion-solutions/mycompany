...
- **„Komentarze”** — wątek komentarzy leadu. W komentarzach można wspominać użytkowników przez **@**; załączone pliki i kluczowe zmiany są pokazywane razem z komentarzami. Sprzedawca leadu i wspomniani użytkownicy mogą otrzymywać powiadomienia e‑mail o nowych komentarzach (włączane w profilu użytkownika). Edytować i usuwać (z potwierdzeniem) można tylko własne komentarze — ikony pojawiają się po najechaniu; edytowany komentarz otrzymuje oznaczenie **„Edytowane”** (po najechaniu widać, kto i kiedy wprowadził zmianę). Użytkownik z flagą **„Zarządzanie wszystkimi komentarzami”** na karcie pracownika może edytować i usuwać dowolne komentarze. Ustawienie **„Okres edycji komentarza (min)”** (**Dane podstawowe → Ustawienia**) ogranicza czas, w którym autor może zmieniać komentarz (nie dotyczy moderatorów; puste — bez ograniczenia).
