...
- czy dozwolona jest rejestracja czasu bez geolokacji;
- parametry kiosku (w tym użycie zdjęć);
- szablony wydruków identyfikatorów (jeśli identyfikatory są używane).
