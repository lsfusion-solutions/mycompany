...
Projekt łączy powiązane **[zagadnienia](tasks.md)**, **[zespół i role](team-and-roles.md)** oraz nakład pracy rejestrowany w **[przepracowanym czasie](time-entries.md)**. Zaleca się używać projektu jako „kontenera pracy”: zapisywać daty, osobę odpowiedzialną oraz kluczowe decyzje.
...
Dalej: zobacz [Zagadnienia](tasks.md) i [Przepracowany czas](time-entries.md).
