...
Umowa może służyć jako karta do przechowywania warunków: dat obowiązywania, partnera, kwot (jeśli dotyczy) oraz powiązania z konkretnym pojazdem.
...
### Daty obowiązywania i kontrola wygaśnięcia
...
Karta pojazdu pokazuje listę powiązanych umów. Jest to wygodne do kontroli dat i warunków dla konkretnego pojazdu.
