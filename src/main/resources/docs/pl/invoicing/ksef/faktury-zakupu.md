...
3. Uruchom akcję utworzenia faktury zakupu (jeśli jest dostępna w Twojej konfiguracji).
4. Sprawdź utworzoną fakturę zakupu: partnera, daty, kwoty, linie, podatki.
