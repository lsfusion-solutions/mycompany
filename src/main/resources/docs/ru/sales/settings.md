...
- **тип производственного заказа** — для автоматического создания производственных заказов из заказа покупателя;
...
- **запрет блокировки при активных отгрузках**, **запрет блокировки при неполной отгрузке** и **запрет блокировки при неполной оплате** — ограничения перехода в статус «Заблокирован».
