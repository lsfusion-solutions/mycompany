...
![Список заказов покупателей](images/orders-list.webp)
...
![Карточка заказа покупателя](images/order-card.webp)
...
Заказ проходит статусы **«Черновик» → «Отправлен» → «Подтверждён» → «Заблокирован»** и может быть **отменён** из любого статуса, кроме «Черновика».
