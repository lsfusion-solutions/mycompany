...
![Список зарплатных ведомостей](images/payslip-batches.webp)
...
![Карточка зарплатной ведомости](images/payslip-batch-card.webp)
...
Если расчётный лист, уже связанный с ведомостью, относится к сотруднику, не принадлежащему **организации** ведомости, действие **«Сгенерировать»** прерывается с ошибкой и ничего не меняет — исправьте или удалите такой расчётный лист и повторите.
...
После копирования проверьте период и расчётные листы в новой ведомости и при необходимости выполните **«Сгенерировать»**.