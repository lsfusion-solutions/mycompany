...
- Список **«Регистрация времени»** находится в **«Кадры» → «Операции» → «Регистрация времени»**.
...
Диалог подтверждается автоматически через несколько секунд, либо сотрудник может нажать **Отмена**. Если сотрудник не распознан, на экране отображается сообщение **«Сотрудник не найден»**.
