...
*   **Ключ** — API ключ, полученный в личном кабинете Zadarma.
*   **Секрет** — API секрет, полученный в личном кабинете Zadarma.
...
3.  Настройка **Play record remotely** в конфигурации Zadarma определяет способ воспроизведения.
