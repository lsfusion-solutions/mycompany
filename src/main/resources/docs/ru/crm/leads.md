...
- **«Комментарии»** — лента комментариев по лиду. В комментариях можно упоминать пользователей через **@**; прикреплённые файлы и ключевые изменения показываются вместе с комментариями. Менеджер лида и упомянутые пользователи могут получать уведомления о новых комментариях по почте (включается в профиле пользователя). Редактировать и удалять (с подтверждением) можно только свои комментарии — значки появляются при наведении; отредактированный комментарий получает пометку **«Изменено»** (при наведении на неё видно, кто и когда внёс правку). Пользователь с флагом **«Управление всеми комментариями»** на карточке сотрудника может редактировать и удалять любые комментарии. Настройка **«Период редактирования комментария (мин)»** («Справочники» → «Настройки») ограничивает время, в течение которого автор может менять комментарий (на модераторов не действует; пустое значение — без ограничения).
