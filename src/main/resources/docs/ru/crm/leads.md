...
- блок связанных документов (заказы, реализации) — если включены соответствующие разделы.
...
- основные параметры: **Тип лида**, **Контрагент**, **Электронная почта**, **Телефон**, **Менеджер по продажам**, **Приоритет лида**, **Ярлыки лида**.
...
2. Укажите **Контрагента**, если он известен.
...
- нет ли связанных заказов и реализаций;
