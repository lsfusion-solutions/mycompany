...
- списания товара из места хранения (обычная отгрузка);
- перемещения товара между местами хранения (если выбран тип с признаком «перемещение»).
...
- место хранения‑источник и (для перемещений) место хранения‑назначение;
- примечание;
- количество строк.
...
Дополнительно на вкладке показываются подсказки по остаткам в месте хранения‑источнике и подсветка, если суммарное планируемое количество превышает доступный остаток.
...
- **Тип** — влияет на нумерацию, места хранения по умолчанию и ограничения;
- **Плановая дата**;
- **Номер**;
- **Контрагент** (для обычной отгрузки);
- **Место хранения‑источник** — обязательное поле;
- **Место хранения‑назначение** — обязательное поле для перемещения;
