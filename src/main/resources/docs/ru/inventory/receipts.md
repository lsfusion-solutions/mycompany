...
Поступление фиксирует приход товара в место хранения.

Документ используется, чтобы:

- зафиксировать планируемое и фактическое количество к приёмке;
- принять товар в конкретное место хранения;
...
- **Тип** — влияет на нумерацию, место хранения по умолчанию и ограничения;
...
Практический совет: сначала выберите тип и место хранения — после этого удобнее добавлять строки.
...
4. **Размещение** — размещение по дочерним местам хранения.
   ...
   - в размещении контролируется, что выбранное место хранения является дочерним от места хранения, указанного в документе, и что суммарно размещено не больше, чем принято.
...
- **Не удаётся завершить** — не заполнено место хранения или есть строки без количества.
