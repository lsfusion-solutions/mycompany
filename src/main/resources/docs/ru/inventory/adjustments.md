...
Инвентаризация (пересчёт) используется для сравнения учётного остатка с фактическим количеством в месте хранения.
...
1. **Подготовка**
   - Определите **периметр**: место хранения/зона/ячейка, группы товаров, необходимость учёта по партиям/упаковкам.
   - Зафиксируйте момент «среза»:
     - по возможности завершите незакрытые **поступления/отгрузки/перемещения** по выбранному месту хранения;
...
2. **Создание документа**
   - Создайте **инвентаризацию** и укажите **место хранения**.
...
4. **Ввод фактических остатков**
   ...
   - Если включён учёт по партиям/сериям — вводите количество **в разрезе партий**.
...
5. **Проверка и сверка**
   ...
   - При больших расхождениях:
     ...
     - проверьте, что выбранное **место хранения** совпадает с фактическим.
...
- **Расхождения слишком большие** — проверьте единицы измерения и место хранения.
