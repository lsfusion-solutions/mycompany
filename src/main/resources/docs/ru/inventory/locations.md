...
Опционально в **«Склад» → «Настройка» → «Настройки»** можно включить признак **«Запретить несколько корневых мест хранения»** — тогда у каждого нового места хранения обязательно должен быть родитель (защита от случайных «разрозненных» деревьев).
