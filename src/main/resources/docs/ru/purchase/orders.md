...
**Заказ поставщику** фиксирует договорённость о поставке и используется для:
...
- **поставщика**;
- **организацию**;
- **место хранения** (если используется складской контур);
- **валюту** (если используется многовалютность);
...
### Приемки (если используется склад)
...
- создавать «черновую»/готовую к работе приемку, чтобы склад мог начать оформление поступления в место хранения.

Подробнее: [Приемки по заказам поставщикам](receipts.md).

### Поступления и оплата (если используется раздел «Расчёты»)
