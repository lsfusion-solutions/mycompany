...
- редактируйте и удаляйте свои комментарии (чужие — только при наличии флага **«Управление всеми комментариями»** на карточке сотрудника); правки помечаются как **«Изменено»**.
