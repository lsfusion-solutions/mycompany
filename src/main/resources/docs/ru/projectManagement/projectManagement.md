...
- **Операции** — ежедневная работа (**[проекты](projects.md)**, **[задачи](tasks.md)**, **[отметки времени](time-entries.md)**, смены). **[Доска задач](tasks.md#доска-задач)** и **[диаграмма Ганта](tasks.md#диаграмма-ганта)** — это представления внутри списка задач, а не отдельные пункты меню. **[Назначения](team-and-roles.md#назначения)** ведутся в карточке проекта.
