...
![Список проектов с фильтрами](images/projects-list.webp)
...
![Карточка проекта](images/project-card.webp)
...
- **активным** — ни закрыт, ни архивный (этот отбор используется в списке проектов по умолчанию).
