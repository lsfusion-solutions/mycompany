...
- редактировать и удалять (с подтверждением) можно только свои комментарии; пользователь с флагом **«Управление всеми комментариями»** на карточке сотрудника — любые;
- отредактированный комментарий получает пометку **«Изменено»**.
