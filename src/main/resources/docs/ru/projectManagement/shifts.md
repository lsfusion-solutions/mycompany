...
После этого смена отображается **в обратном порядке**, с меткой следующего дня — `22:00-06:00 (+1)` — везде, где она встречается: в карточке смены, в списке смен и на доске **«Расписание»**.
