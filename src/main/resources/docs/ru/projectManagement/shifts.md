...
![Список смен](images/shifts-list.webp)
...
![Карточка смены](images/shift-card.webp)
...
![Представление «Расписание»](images/shift-schedule.webp)
...
![Вкладка «Шаблоны смен» в настройках](images/shift-templates.webp)
