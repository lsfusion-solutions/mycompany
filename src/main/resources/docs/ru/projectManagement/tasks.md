...
![Список задач с цветовой кодировкой по приоритету](images/tasks-list.webp)
...
![Карточка задачи: статус-панель, поля, комментарии](images/task-card.webp)
...
![Доска задач (Kanban): колонки — статусы](images/task-kanban.webp)
...
![Диаграмма Ганта задач](images/task-gantt.webp)
