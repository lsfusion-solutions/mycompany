...
![Табель менеджера: сотрудники по дням периода](images/timesheet-supervisor.webp)
...
- сотрудников, у которых уже есть часы/отметки времени в выбранном периоде (независимо от того, активны они или нет);
- (в некоторых конфигурациях) **активных** сотрудников, доступных пользователю с расширенными правами ("доступ ко всем проектам").
...
Если включена настройка **автосохранения часов** (задаётся в **«Проекты» → «Настройка» → «Настройки»**), такие действия запрашивают подтверждение, потому что изменения сразу записываются.
...
![Табель сотрудника: задачи по дням периода](images/timesheet-employee.webp)
