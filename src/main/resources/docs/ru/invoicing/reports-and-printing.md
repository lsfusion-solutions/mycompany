...
Шаблон печати — это печатная форма, по которой система формирует документ при нажатии кнопки «Печать» в карточке «Реализации».

Для каждого **типа реализации** можно подключить один или несколько шаблонов. Если шаблонов несколько, пользователь выбирает нужный при печати.
...
Кнопка «Печать» отображается в карточке «Реализации» только если для её типа включён хотя бы один шаблон печати.
...
Обычно эти действия выполняются в разделе «Настройки»:
...
Откройте нужную «Реализацию» и нажмите «Печать».
...
- отчёты по поступлениям;
- отчёты по реализациям;
- отчёты по платежам;
- отчёты по задолженности.

Рекомендации:

1. Используйте интервал дат.
2. Для анализа задолженности группируйте по контрагенту и договору.
