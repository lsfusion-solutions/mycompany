...
- заполнить ключ доступа OpenAI и при необходимости указать модель по умолчанию;
...
3. Запустите импорт и выберите файл с документом поставщика. Стандартный сценарий рассчитан на один документ в одном файле.
