...
- при каждом пересчёте строк производственные задания перестраиваются по текущим операциям спецификации, включая операции вложенных промежуточных спецификаций.
