...
> Кнопки **«Внести наличные»** и **«Изъять»** доступны, только если у кассы задан **наличный счёт** — счёт для способа оплаты **«Наличные»**. Если он не настроен, кнопки неактивны (а поле «Наличных в кассе» пустое). Настраивается этот счёт в карточке кассы — см. [Настройки розницы](settings.md).
