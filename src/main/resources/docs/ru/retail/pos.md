...
Оба действия открывают диалог с цифровой клавиатурой для ввода суммы и регистрируются по открытой смене; выполненные операции показываются в этих же списках.
...
Вкладка **«Смена»** показывает номер смены, время открытия и итоги, включая сумму, принятую каждым методом оплаты. Списки **«Чеки»** и **«Возвраты»** показывают продажи и возвраты, выполненные в смене.
