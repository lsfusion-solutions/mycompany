...
> **Счёт центральной кассы.** Поле **«Касса»** в шапке карточки кассы — это **счёт центральной кассы**, контрагентский счёт для операций **«Внести наличные»** и **«Изъять»**: при внесении деньги переводятся со счёта центральной кассы в **денежный ящик ККМ** (счёт способа оплаты **«Наличные»**), при изъятии — обратно. Поэтому счёт в поле **«Касса»** должен **отличаться** от счёта, указанного для способа оплаты **«Наличные»**. Если это один и тот же счёт, внесение/изъятие проводит обе стороны перевода по одному счёту, сумма обнуляется, и остаток в поле **«Наличных в кассе»** не меняется. Система это контролирует — кассу с одинаковым счётом в обоих местах сохранить не получится.
