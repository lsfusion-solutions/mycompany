...
1. Откройте **«Розница» → «Настройка» → «Настройки»** и убедитесь, что:
...
5. Перейдите к оплате, укажите суммы по способам оплаты и подтвердите.
...
- **Настройка** — форма **«Настройки»** и справочники **«Кассы»** и **«Дисконтные карты»**.
...
![Раздел «Розница» в навигаторе](images/retail-nav.webp)
