...
- **Управление всеми комментариями** — флаг модератора: по умолчанию пользователь может редактировать и удалять только свои комментарии, флаг снимает это ограничение;
