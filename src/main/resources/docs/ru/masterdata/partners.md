...
- **Наименование**;
- **Тип** — вид контрагента (например, организация, компания, физическое лицо, сотрудник); определяется типом создаваемой записи и показывается только для чтения;
- **Адрес** (включая страну — если используется);
- **Телефон**, **электронная почта**;
- **Архивирован** — признак вывода из активного использования.

![Карточка контрагента](images/partner-card.webp)
