...
- **Наименование** — редактируемое наименование позиции;
- **Полное наименование** — формируется автоматически (префикс категории + наименование + префиксы/суффиксы атрибутов); только для чтения;
