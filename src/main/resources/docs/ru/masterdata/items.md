...
- заполнить ключ доступа OpenAI и при необходимости указать модель по умолчанию в общих настройках интеграции;
...
3. Нажмите **Import (GPT)** и выберите исходный файл.
