...
![Список водителей](images/drivers-list.webp)
...
При выборе транспортного средства поле **«Сотрудник»** заполняется предыдущим водителем этого ТС (если он был) — замените его на нового водителя. **«Дата с»** по умолчанию равна текущей дате.
