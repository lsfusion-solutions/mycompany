...
2. Укажите:
   ...
   - сотрудника (водителя);
   - показания одометра (если требуется);
...
- Если в вашей организации фиксируются показания одометра, удобно указывать их при смене водителя — это помогает сверять пробег и обслуживать ТС по регламенту.
