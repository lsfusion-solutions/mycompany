...
Раздел предназначен для ведения списка транспортных средств и просмотра всей связанной информации: назначений водителей, обслуживаний, договоров и приложенных файлов.
...
Ярлыки используются как дополнительные метки для удобства фильтрации и контроля.
...
- **Водители** — назначения водителей с датами.
- **Обслуживания ТС** — история обслуживаний и затрат.
- **Договоры** — привязанные договоры.
