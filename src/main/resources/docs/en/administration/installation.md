...
Download and run MyCompany installer: https://download.lsfusion.org/solutions/mycompany-6.2-x64.exe.

Otherwise follow the steps below:

1. Download and run lsFusion platform installer (execution) : https://docs.lsfusion.org/Execution_auto/.
2. Download the assembled jar file with MyCompany logic from https://download.lsfusion.org/solutions/mycompany-6.2.jar.
