...
- whenever lines are recalculated, work orders are regenerated from the current Bill of Materials operations, including operations from nested intermediate Bills of Materials.
